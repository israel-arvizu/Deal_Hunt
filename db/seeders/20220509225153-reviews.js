  ...
  up: (queryInterface, Sequelize) => {
    ...
    */
    return queryInterface.bulkInsert('Reviews', [
      { albumId: 6, userId: 3, content: "On their new album, the artist turns their steady gaze towards the wreckage of the last few years and still finds a way to prioritize compassion.", createdAt: '2019-04-12', updatedAt: '2019-04-12' },
